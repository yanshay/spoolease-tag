...
(async () => {
  ...
  if (!consoleAddress) {
    ...
    window.location.href = "https://tag.spoolease.io/config.html?config=missingConfig";
    return;
  }
  ...
  if (!fwdidsuccess) {
    ...
    if (forwardId > lastForwardSuccess) {
      ...
      window.location.href = "https://tag.spoolease.io/config.html?config=forwardFailed";
      return;
    }
