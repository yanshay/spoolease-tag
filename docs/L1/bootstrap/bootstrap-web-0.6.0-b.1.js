...
(async () => {
  ...
  if (!consoleAddress) {
    ...
    window.location.href = "https://tag.spoolease.io/L1/config.html?config=missingConfig";
    return;
  }
  ...
  if (!fwdidsuccess) {
    ...
    if (forwardId > lastForwardSuccess) {
      ...
      window.location.href = "https://tag.spoolease.io/L1/config.html?config=forwardFailed";
      return;
    }
